...
- [ ] **v1.5** — [Prototype-grade font morphing](./docs/roadmap.md#v15--prototype-grade-font-morphing-cli-planned): `fontfetch morph <file> --round --width --slant --weight --rename`. Pre-commission sketchbook for designers — four sliders, real binary out, OFL-rename-enforced. Webapp `/edit/[id]` with live preview + share-to-client links lands in v1.6; community preset library in v1.7.
